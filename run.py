...
def checkLeftRight(image, results, draw=False, display=False):
    ...
    if (right_x <= left_shoulder_x or left_x <= left_shoulder_x):
        # print(f'left hand: {left_x}, left_shoulder_x: {left_shoulder_x}, right hand: {right_x}, right_shoulder_x:{right_shoulder_x}')
    ...
    # the following cases are identified as center: two hands are in the middle of two shoulder or left hand on left
    # right hand on right
    # elif right_x > right_shoulder_x and left_x < right_shoulder_x:
